...
import me.piepers.king.application.SlotCommandHandlerVerticle;
    ...
    public void start(Future<Void> startFuture) throws Exception {
        ...
        configRetriever.rxGetConfig().flatMapCompletable(configuration -> {
            ...
            return Completable.fromAction(() -> LOGGER.debug("Deploying Team King Slot machine backend"))
                    ...
                    .toCompletable()
                    .andThen(this.vertx.rxDeployVerticle(HttpServerVerticle.class.getName(), new DeploymentOptions().setConfig(configuration)))
                    .toCompletable();
                }
        );
    }
